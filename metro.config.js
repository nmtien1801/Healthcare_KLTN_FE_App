...
export const URL_ANDROID=process.env.EXPO_PUBLIC_URL_ANDROID
export const URL_WEB=process.env.EXPO_PUBLIC_URL_WEB
...
export const FIREBASE_DATABASE_URL=process.env.EXPO_PUBLIC_FIREBASE_DATABASE_URL
export const BOOKING_FEE=process.env.EXPO_PUBLIC_BOOKING_FEE
`;
