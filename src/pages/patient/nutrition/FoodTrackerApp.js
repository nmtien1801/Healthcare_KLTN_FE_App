  ...
  return (
    <View style={styles.statsCard}>
      ...
      <View style={styles.statsValue}>
        ...
        <Text style={styles.targetText}>/ {stat.target}{stat.unit}</Text>
      </View>
...
const MealSection = ({
  ...
  const getDiabetesRating = () => {
    if (mealNutrition.carbs > 30) return { text: '⚠️ Nhiều carbs - cần theo dõi đường huyết' };
    if (mealNutrition.protein > 15) return { text: '✅ Tốt - giàu protein ổn định đường huyết' };
    if (mealNutrition.fat > 10) return { text: '💡 Nhiều chất béo - no lâu nhưng cần kiểm soát' };
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 12 }}>
          <View style={styles.nutritionGrid}>
            <View style={[
              ...
              <Text style={[styles.nutritionValue, { color: currentMealColor.text }]}>
                {mealNutrition.protein}g
              </Text>
              <Text style={[styles.nutritionLabel, { color: currentMealColor.text }]}>
                Protein
              </Text>
            </View>
        ...
        <>
          ...
          {mealFoods.length > 0 ? (
            ...
            <View style={[
              ...
              <Text style={[styles.emptyMealIcon, { color: currentMealColor.text }]}>
                🍽️
              </Text>
              <Text style={[styles.emptyMealText, { color: currentMealColor.text }]}>
...
export default function FoodTrackerApp() {
  let [food, setFood] = useState([]); // storage
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.headerTitle}>🍽️ Theo dõi Dinh dưỡng Hàng ngày</Text>
          <Text style={styles.headerSubtitle}>
            Quản lý chế độ ăn uống khoa học cho bệnh nhân tiểu đường
          </Text>
        </View>

        <StatsGrid target={food?.sum} foods={foods} />
