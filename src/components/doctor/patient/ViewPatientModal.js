...
import { Calendar, Phone, Mail, MapPin, Heart, AlertTriangle, User, FileText, UserCheck, X } from "lucide-react-native";
            ...
            <View style={styles.modalOverlay}>
                ...
                <View style={styles.modalContent}>
                    ...
                    <ScrollView contentContainerStyle={styles.modalBody}>
                        ...
                        <View style={styles.headerContainer}>
                            ...
                            <View style={styles.headerInfo}>
                                ...
                                <Text style={styles.patientAge}>Tuổi: {patient.patientCount}</Text>
                            ...
                            <View style={styles.healthRow}>
                                ...
                                <View style={styles.healthItem}>
                                    <View style={styles.healthLabelRow}>
                                        ...
                                        <Text style={[styles.healthLabel, styles.dangerText]}>Dị ứng</Text>
                                    </View>
                                    <Text style={styles.healthValue}>{patient.allergies || "Không"}</Text>
                                </View>
                            </View>
                        </View>
                                ...
                                <FlatList
                                    ...
                                    renderItem={({ item: record }) => (
                                        <View style={styles.tableRow}>
                                            ...
                                            <Text style={styles.tableCell}>{record.bloodPressure}</Text>
                                    ...
                                    ListHeaderComponent={() => (
                                        <View style={styles.tableHeader}>
                                            ...
                                            <Text style={styles.tableHeaderCell}>Thời gian ghi nhận</Text>
                                        </View>
                                    )}
                                    showsVerticalScrollIndicator={false}
                                />
                            ) : (
                                <Text style={styles.emptyText}>Không có hồ sơ sức khỏe nào.</Text>
                            )}
                        </View>
                            ...
                            <View style={styles.timelineContainer}>
                                <View style={styles.timelineItem}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.timelineDescription}>Khám định kỳ - {patient.disease}</Text>
                                        <Text style={styles.timelineDescription}>Tình trạng: {patient.status}</Text>
                                    </View>
                                </View>
                            </View>
                            <TouchableOpacity
                    ...
                    <View style={styles.modalFooter}>
                        ...
                        <TouchableOpacity style={[styles.footerButton, styles.primaryButton]} onPress={() => onEdit(patient)}>
                            <Text style={[styles.footerButtonText, styles.primaryButtonText]}>Chỉnh sửa</Text>
                        </TouchableOpacity>
                    </View>
