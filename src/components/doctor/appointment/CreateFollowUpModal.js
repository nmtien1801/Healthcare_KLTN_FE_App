...
const styles = StyleSheet.create({
    ...
    modalContainer: { width: "90%", maxHeight: "90%", backgroundColor: "#fff", borderRadius: 16, padding: 20 },
    ...
    button: { padding: 10, borderRadius: 8, marginLeft: 10, minWidth: 90, alignItems: "center" },
    ...
    alertBoxSuccess: { backgroundColor: "#fff", borderRadius: 10, padding: 20, width: "80%", alignItems: "center" },
    alertBoxError: { backgroundColor: "#fff", borderRadius: 10, padding: 20, width: "80%", alignItems: "center" },
